...
public class UserService implements UserDetailsService {
    ...
    public List<User> getUsersByRole(Role role) { return userRepository.findAllByRolesContaining(role); }

    public List<User> getPendingUsers() { return userRepository.findAllByStatus(Status.PENDING); }
